...
namespace SeleniumWorker
{
    ...
    public class UnitTest1
    {
        ...
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV",
                    "|DataDirectory|\\testdata\\P_SchriftWechMitAendLTERDetailed.csv",
                    "P_SchriftWechMitAendLTERDetailed#csv",
                    DataAccessMethod.Sequential),
                    DeploymentItem("testdata\\P_SchriftWechMitAendLTERDetailed.csv")]
        ...
        public void P_SchriftWechMitAendLTERDetailed()
        {
