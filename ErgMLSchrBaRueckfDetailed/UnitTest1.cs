...
{
    [TestClass]
    public class ErgMLSchrBaRueckfDetailed
    {
        #region TestContext
        ...
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV",
                    "|DataDirectory|\\testdata\\P_ErgMLSchrBaRueckfDetailed.csv",
                    "P_ErgMLSchrBaRueckfDetailed#csv",
                    DataAccessMethod.Sequential),
                    DeploymentItem("testdata\\P_ErgMLSchrBaRueckfDetailed.csv")]
