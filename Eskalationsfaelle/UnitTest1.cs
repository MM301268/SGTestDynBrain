...
{
    [TestClass]
    public class Eskalationsfaelle
    {
        #region TestContext
        ...
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV",
                    "|DataDirectory|\\testdata\\P_EskalationsfaelleDetailed.csv",
                    "P_EskalationsfaelleDetailed#csv",
                    DataAccessMethod.Sequential),
                    DeploymentItem("testdata\\P_EskalationsfaelleDetailed.csv")]
        ...
        public void P_EskalationsfaelleDetailed()
        {
