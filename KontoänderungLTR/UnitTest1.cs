...
namespace SeleniumWorker
{
    ...
    public class UnitTest1
    {
        ...
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV",
                    "|DataDirectory|\\testdata\\P_KontoaenderungLTRDetailed.csv",
                    "P_KontoaenderungLTRDetailed#csv",
                    DataAccessMethod.Sequential),
                    DeploymentItem("testdata\\P_KontoaenderungLTRDetailed.csv")]
        ...
        public void P_KontoaenderungLTERDetailed()
        {
