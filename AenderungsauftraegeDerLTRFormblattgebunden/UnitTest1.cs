...
{
    [TestClass]
    public class AenderungsauftraegeDerLTRFormblattgebunden
    {
        #region TestContext
        ...
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV",
                    "|DataDirectory|\\testdata\\P_AenderungsauftraegeDerLTRFormblattgebunden.csv",
                    "P_AenderungsauftraegeDerLTRFormblattgebunden#csv",
                    DataAccessMethod.Sequential),
                    DeploymentItem("testdata\\P_AenderungsauftraegeDerLTRFormblattgebunden.csv")]
        ...
        public void P_AenderungsauftraegeDerLTRFormblattgebunden()
        {
