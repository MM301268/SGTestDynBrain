...
namespace SeleniumWorker
{
    ...
    public class Kontoänderung
    {
        ...
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV",
                    "|DataDirectory|\\testdata\\P_KontoaenderungDetailed.csv",
                    "P_KontoaenderungDetailed#csv",
                    DataAccessMethod.Sequential),
                    DeploymentItem("testdata\\P_KontoaenderungDetailed.csv")]
        ...
        public void P_KontoaenderungDetailed()
        {
