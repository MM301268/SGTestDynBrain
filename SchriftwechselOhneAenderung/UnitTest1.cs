...
namespace SeleniumWorker
{
    ...
    public class UnitTest1
    {
        ...
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV",
                    "|DataDirectory|\\testdata\\P_SchriftWechOhneAendDetailed.csv",
                    "P_SchriftWechOhneAendDetailed#csv",
                    DataAccessMethod.Sequential),
                    DeploymentItem("testdata\\P_SchriftWechOhneAendDetailed.csv")]
        ...
        public void SchriftWechOhneAendLTERDetailed()
        {
