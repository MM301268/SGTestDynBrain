...
namespace SeleniumWorker
{
    ...
    public class UnitTest1
    {
        ...
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV",
                    "|DataDirectory|\\testdata\\P_SchriftWechMitAendDetailed.csv",
                    "P_SchriftWechMitAendDetailed#csv",
                    DataAccessMethod.Sequential),
                    DeploymentItem("testdata\\P_SchriftWechMitAendDetailed.csv")]
        ...
        public void P_SchriftWechMitAendDetailed()
        {
