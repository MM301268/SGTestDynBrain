...
namespace SeleniumWorker
{
    ...
    public class UnitTest1
    {
        ...
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV",
                    "|DataDirectory|\\testdata\\P_SchriftWechOhneAendLTRDetailed.csv",
                    "P_SchriftWechOhneAendLTRDetailed#csv",
                    DataAccessMethod.Sequential),
                    DeploymentItem("testdata\\P_SchriftWechOhneAendLTRDetailed.csv")]
        ...
        public void P_SchriftWechOhneAendDetailed()
        {
